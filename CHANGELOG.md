...
- **The version string is defined once.** It had been written by hand in the page footer
  and again inside the PDF footer, and the two drifted: every report generated between
  3.2.0 and 3.4.0 printed "Generated by Foundation Forensics v3.2.0" whatever build
  produced it. Both now read `APP_VERSION`.
